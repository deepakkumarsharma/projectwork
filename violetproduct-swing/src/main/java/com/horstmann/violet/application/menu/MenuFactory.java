...
public class MenuFactory
{
    ...
    public AdditionalFeatureMenu getAdditionalFeatureMenu(MainFrame sixThreeFourOne)
    {
        if (this.additionalFeatureMenu == null)
        {
            this.additionalFeatureMenu = new AdditionalFeatureMenu(sixThreeFourOne);
        }
        return this.additionalFeatureMenu;
    }    
    ...
    private AdditionalFeatureMenu additionalFeatureMenu;
}
